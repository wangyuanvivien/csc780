 ...
 */
package edu.sfsu.easymemo.language;

import edu.sfsu.easymemo.ocr.OCRActivity;
import edu.sfsu.easymemo.ocr.PreferencesActivity;
...
public class Translator {
  ...
  static String translate(Activity activity, String sourceLanguageCode, String targetLanguageCode, String sourceText) {   
    ...
    String api = prefs.getString(PreferencesActivity.KEY_TRANSLATOR, OCRActivity.DEFAULT_TRANSLATOR);
